...
В терминале виртуальной машины выполнено монтирование общей папки и проверка наличия файла imp.txt:
...
Все запросы из дампа были последовательно выполнены в DBeaver:

Запрос 1: Создание схемы

sql
CREATE SCHEMA IF NOT EXISTS pm;
https://screenshots/5_create_schema.png

Запрос 2: Создание таблиц
...
📈 Данные в дашборде
Диаграмма 1: Проекты и задачи (Таблица)
...
Диаграмма 2: Задачи по приоритетам (Круговая)
...
Диаграмма 3: Задачи по проектам (Столбчатая)
Разработка CRM: 3 задачи

Мобильное приложение: 3 задачи

Внедрение BI: 2 задачи

Диаграмма 4: Загрузка сотрудников (Горизонтальная)
